/*
 * This class creates the Fail Frame which is a frame that displays when the
 * user gets 3 or less questions wrong. It is a certificate designed to pity
 * the user since they could not answer such simple questions on a 5 question
 * test
 */
...
public class FailFrame extends JFrame {
	...
	public FailFrame(){
		...
		ImageIcon background = new ImageIcon("files/failframe.png");
